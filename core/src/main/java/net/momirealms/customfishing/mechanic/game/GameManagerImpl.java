...
public class GameManagerImpl implements GameManager {
    ...
    public HashMap<String, Double> getGameWithWeight(PlayerContext playerContext) {
        return ((RequirementManagerImpl) plugin.getRequirementManager()).getGameWithWeight(playerContext);
    }
    ...
    private void registerTensionGame() {
        this.registerGameType("tension", (section -> {
            ...
            return (player, fishHook, settings) -> new AbstractGamingPlayer(player, fishHook, settings) {
                ...
                @Override
                public void arrangeTask() {
                    this.task = BukkitCustomFishingPlugin.get().getScheduler().runTaskAsyncTimer(this, 50, 40, TimeUnit.MILLISECONDS);
                }
        ...
        this.registerGameType("dance", (section -> {
            ...
            return (player, fishHook, settings) -> new AbstractGamingPlayer(player, fishHook, settings) {
                ...
                public void arrangeTask() {
                    ...
                    this.task = BukkitCustomFishingPlugin.get().getScheduler().runTaskAsyncTimer(this, 50, 50, TimeUnit.MILLISECONDS);
                }
