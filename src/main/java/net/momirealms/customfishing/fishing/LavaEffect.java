...
public class LavaEffect implements Runnable {
    ...
    public LavaEffect(Location loc, int delay) {
        ...
        this.lavaTask = CustomFishing.getInstance().getScheduler().runTaskTimerAsync(this, delay * 50L, 50, TimeUnit.MILLISECONDS);
    }
